...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['VS Jackhammer Mod Team'],
			['Woofle',		'woofle',		'Musician, Programmer,\nand Secondary Artist',		'https://linktr.ee/sebyamador',		'0xFF0049FF'],
			['Beeblockzz',		'beeb',		'Primary Artist and Father of Jackson',		'https://twitter.com/BeeBlockzz/status/1457180449621504005?s=20',		'0xFFA71C1C'],
			[''],
			['Psych Engine Team'],
